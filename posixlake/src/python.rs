// Python bindings for posixlake using UniFFI
//
// This module provides Python bindings for all posixlake functionality including:
...
impl From<CoreError> for PosixLakeError {
    fn from(err: CoreError) -> Self {
        match err {
            CoreError::Io(e) => PosixLakeError::IoError {
                message: e.to_string(),
            },
            CoreError::Serialization(e) => PosixLakeError::SerializationError {
                message: e.to_string(),
            },
            CoreError::ObjectStore(e) => PosixLakeError::ObjectStoreError {
                message: e.to_string(),
            },
            CoreError::Arrow(e) => PosixLakeError::ArrowError {
                message: e.to_string(),
            },
            CoreError::Parquet(e) => PosixLakeError::ParquetError {
                message: e.to_string(),
            },
            CoreError::DatabaseNotFound(msg) => PosixLakeError::DatabaseNotFound { message: msg },
            CoreError::RecordNotFound(msg) => PosixLakeError::RecordNotFound { message: msg },
            ...
            CoreError::Other(msg) => PosixLakeError::Other { message: msg },
        }
    }
}
...
impl Schema {
    fn to_arrow_schema(&self) -> Result<Arc<ArrowSchema>, PosixLakeError> {
...
impl DatabaseOps {
    ...
    pub fn insert_json(&self, json_data: String) -> Result<u64, PosixLakeError> {
        let value: Value =
    ...
    pub fn insert_buffered_json(&self, json_data: String) -> Result<u64, PosixLakeError> {
        let value: Value =
            serde_json::from_str(&json_data).map_err(|e| PosixLakeError::SerializationError {
                message: e.to_string(),
            })?;
    ...
    pub fn flush_write_buffer(&self) -> Result<(), PosixLakeError> {
        self.runtime.block_on(self.inner.flush_write_buffer())?;
        Ok(())
    }

    /// Query data with SQL
    pub fn query(&self, sql: String) -> Result<Vec<Row>, PosixLakeError> {
    ...
    pub fn query_json(&self, sql: String) -> Result<String, PosixLakeError> {
        let result = self.runtime.block_on(self.inner.query(&sql))?;
        let json_array = self.record_batches_to_json(result)?;
        serde_json::to_string_pretty(&json_array).map_err(|e| PosixLakeError::SerializationError {
            message: e.to_string(),
        })
    }

    /// Delete rows matching a WHERE clause
    pub fn delete_rows_where(&self, predicate: String) -> Result<u64, PosixLakeError> {
        let count = self
            .runtime
    ...
    pub fn merge_json(
        ...
        serde_json::to_string_pretty(&result).map_err(|e| PosixLakeError::SerializationError {
            message: e.to_string(),
        })
    }
    ...
    pub fn query_version(&self, sql: String, version: i64) -> Result<Vec<Row>, PosixLakeError> {
        let result = self
            .runtime
    ...
    pub fn query_version_json(&self, sql: String, version: i64) -> Result<String, PosixLakeError> {
        let result = self
            .runtime
            .block_on(self.inner.query_version(&sql, version))?;
        let json_array = self.record_batches_to_json(result)?;
    ...
    pub fn optimize(&self) -> Result<(), PosixLakeError> {
        self.runtime.block_on(self.inner.optimize())?;
        Ok(())
    }

    /// Run OPTIMIZE with a target file size
    pub fn optimize_with_target_size(&self, target_size_bytes: u64) -> Result<(), PosixLakeError> {
        self.runtime
    ...
    pub fn optimize_with_filter(&self, filter: String) -> Result<(), PosixLakeError> {
        self.runtime
    ...
    pub fn vacuum(&self, retention_hours: u64) -> Result<(), PosixLakeError> {
        self.runtime.block_on(self.inner.vacuum(retention_hours))?;
        Ok(())
    }

    /// Run VACUUM dry run to see what would be deleted
    pub fn vacuum_dry_run(&self, retention_hours: u64) -> Result<Vec<String>, PosixLakeError> {
        let files = self
            .runtime
    ...
    pub fn zorder(&self, columns: Vec<String>) -> Result<(), PosixLakeError> {
    ...
    pub fn backup(&self, backup_path: String) -> Result<(), PosixLakeError> {
    ...
    pub fn get_data_skipping_stats(&self) -> Result<DataSkippingStats, PosixLakeError> {
        let stats = self
            .runtime
...
impl DatabaseOps {
    ...
    fn json_array_to_record_batch(
        &self,
        json_array: &[Value],
    ) -> Result<arrow::array::RecordBatch, PosixLakeError> {
    ...
    ) -> Result<Vec<Value>, PosixLakeError> {
...
impl NfsServer {
    ...
    pub fn shutdown(&self) -> Result<(), PosixLakeError> {
...
#[uniffi::export]
pub fn restore(backup_path: String, restore_path: String) -> Result<(), PosixLakeError> {
