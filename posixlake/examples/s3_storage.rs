...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("   ✓ Local cache: /tmp/posixlake_s3_cache/ (for Delta table operations)");
    println!("   ✓ S3 bucket: posixlake-test");
    ...
    println!("   Local cache (/tmp/posixlake_s3_cache): Fast read access to Delta tables");
    ...
    println!("     docker compose exec minio sh -c \"mc ls myminio/posixlake-test/\"");
    println!();
    println!("   View Delta Lake transaction log:");
    println!("     docker compose exec minio sh -c \"mc ls myminio/posixlake-test/s3_example_db/_delta_log/\"");
