...
use posixlake::metadata::schema::DataTypeRepr;
use posixlake::metadata::{Schema as FsdbSchema, SchemaField, SchemaManager};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("\n=== posixlake Schema Evolution Example ===\n");
    ...
    let db_path = "/tmp/posixlake_example_schema_evolution";
    ...
    println!("  ✓ posixlake automatically unifies schemas when querying mixed versions");
