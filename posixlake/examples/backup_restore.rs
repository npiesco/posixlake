...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("\n=== posixlake Backup & Restore Example ===\n");

    // Setup paths
    let db_path = "/tmp/posixlake_example_backup_original";
    let backup_path = "/tmp/posixlake_example_backup";
    let restore_path = "/tmp/posixlake_example_restore";
    ...
    let incremental_path = "/tmp/posixlake_example_backup_incremental";
    ...
    let pitr_path = "/tmp/posixlake_example_pitr";
